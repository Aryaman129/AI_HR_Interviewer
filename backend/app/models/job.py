...
class Job(Base):
    ...
    company_name = Column(String(255), nullable=False)  # Denormalized for display (legacy)
    ...
    job_description_embedding = Column(Vector(768))  # For semantic job matching
    skills_embedding = Column(Vector(768))  # For skills-based matching
